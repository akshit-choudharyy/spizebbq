            ...
            <div className="relative flex items-center bg-gray-100">
              ...
              <div className="p-6 sm:p-8 lg:p-12"> {/* Reduced p-8 to p-6, sm:p-16 to sm:p-8, lg:p-24 to lg:p-12 */}
                ...
                <p className="mt-4 text-sm text-gray-600"> {/* Reduced text-gray-600 */}
                  Experience the authentic taste of SPIZE BARBEQUE. We bring you a culinary journey through the 
                  diverse and rich taste and From spicy dishes like hot garlic noodles to 
                  delicate flavors like chop suey, our menu is crafted to delight your taste buds with every bite.
                </p>

                <a
                href="https://www.zomato.com/ncr/spize-barbeque-hajipur-noida/order"
                className="mt-6 inline-block rounded border px-8 py-2 text-sm font-medium text-white focus:outline-none focus:ring active:text-indigo-500"
                style={{
                  borderColor: '#FF6500',
